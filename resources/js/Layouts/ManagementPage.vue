...
<template>
    <management-layout title="Sector">
        ...
        <template #actions>
            <el-button type="primary" v-on:Click="openModal()" :icon="CirclePlus">Add {{modelName}}</el-button>
        </template>
        ...
        <template #footerContent>
            <c-modal-form :title="`${modelName} form`" v-on:onSubmit="handerSubmit" :loading="opc.loading" :show="opc.modal"
